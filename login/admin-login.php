				...
				<div class="card mt-5" style="width: 40rem;">
				  <div class="card-header header-title">
				  	...
				  	<div class="d-flex flex-column">
					    ...
					    <h5 class="text-uppercase title-login d-flex justify-content-center">A D M I N</h5>
				    </div>
				  </div>
				  <div class="card-body">
				    <form action="../includes/process/adminLogin.php" method="POST">
							...
							<div class="d-flex justify-content-center mt-3">
								<button type="submit" name="adminLogin" class="btn btn-submit">Enter</button>
							</div>
						</form>
					</div>
